...
export function assertPathInsideWorkspace(workspaceDir: string, candidatePath: string, label = candidatePath): string {
...
function assertRealPathInsideWorkspace(workspaceDir: string, fullPath: string, label: string): void {
