...
export function validateCommand(command, workspaceDir, policyEnabled = true) {
    if (policyEnabled) {
...
export function buildWorkspaceEnv(workspaceDir, additionalEnv = {}) {
    return buildSafeEnv({
        HOME: workspaceDir,
...
export function getUnprivilegedExecOptions() {
...
function validateWorkspaceCommandAccess(command, workspaceDir) {
